        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <small className="pb-4 text-muted d-block">Last updated 3 min ago</small>
              <Link className="btn btn-primary " to="/stays/1">View More</Link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <small className="pb-4 text-muted d-block">Last updated 10 min ago</small>
              <Link className="btn btn-primary " to="/stays/2">View More</Link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <small className="pb-4 text-muted d-block">Last updated 15 min ago</small>
              <Link className="btn btn-primary" to="/stays/3">View More</Link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <small className=" pb-4 text-muted d-block">Last updated 20 min ago</small>
              <Link className="btn btn-primary" to="/stays/4">View More</Link>
            </div>
          </div>
        </div>
      </div>
